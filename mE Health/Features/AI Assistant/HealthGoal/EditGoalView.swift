...
//  mE Health
//
//  Created by Ishant Tiwari on 05/08/25.
//
...
struct EditGoalView: View {
        ...
        )
        {
            GeometryReader { geometry in
                ...
                ZStack(alignment: .topLeading) {
                    ...
                    selectedDate = selectedGoalToEdit?.date ?? ""
                    commentText = selectedGoalToEdit?.goalDescrition ?? ""
                }
            }
    ...
    private func updateGoal() {
        ...
        GoaldataBaseHelper.sharedGoal.updateGoal(by: goalid, updatecomment: commentText, updateDate: selectedDate)
        txtAddGoal = "yes"
        presentationMode.wrappedValue.dismiss()
